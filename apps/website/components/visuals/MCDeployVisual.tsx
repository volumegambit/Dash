...
export function MCDeployVisual() {
  return (
    <div className="bg-command border border-surface-border shadow-lg overflow-hidden w-full">
      {/* Title bar */}
        ...
        <div className="flex-1 p-6 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="bg-surface border border-surface-border px-2 py-1 text-[10px] text-text-muted">
                Code Exec
              </span>
            </div>
          </div>
