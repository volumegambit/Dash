...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .label { font-family: 'JetBrains Mono', monospace; font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 3px; color: #2BBAA0; margin-bottom: 12px; }
    h1 { font-size: 36px; font-weight: 800; letter-spacing: -1px; }
    .count { display: inline-flex; align-items: center; gap: 8px; background: #2BBAA015; border: 1px solid #2BBAA0; border-radius: 100px; padding: 6px 16px; margin-top: 16px; font-size: 14px; color: #2BBAA0; font-weight: 600; }
    .count .dot { width: 8px; height: 8px; border-radius: 50%; background: #2BBAA0; }
    ...
    .logo svg { filter: drop-shadow(0 0 12px rgba(43,186,160,0.3)); }
...
<body>
  <div class="container">
    <div class="logo">
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none"><rect x="2" y="2" width="24" height="24" rx="4" stroke="#2BBAA0" stroke-width="2" fill="none"/><line x1="2" y1="10" x2="26" y2="10" stroke="#2BBAA0" stroke-width="1.5"/><path d="M14 22C14 22 11 17 11 14C11 11 13 9 14 8C15 9 17 11 17 14C17 17 14 22 14 22Z" fill="#2BBAA0"/></svg>
      <span>atrium</span>
    </div>
    <div class="header">
