...
function createMockApi(): MockApi {
  return {
    ...
    chatGetConversation: vi.fn().mockResolvedValue(null),
    chatGetMessages: vi.fn().mockResolvedValue({
      items: [],
      nextCursor: null,
      throughSeq: 0,
    }),
    chatGetInitialState: vi.fn().mockResolvedValue({
      protocol: 'v1',
      page: { items: [], nextCursor: null, throughSeq: 0 },
    }),
    chatGetOlderMessages: vi.fn().mockResolvedValue({
      protocol: 'v1',
      page: { items: [], nextCursor: null, throughSeq: 0 },
    }),
    ...
    chatSubscribeV2: vi.fn().mockResolvedValue(undefined),
    chatUnsubscribeV2: vi.fn().mockResolvedValue(undefined),
    chatEnqueueInput: vi.fn().mockResolvedValue(undefined),
    chatEditFollowUp: vi.fn().mockResolvedValue(undefined),
    chatRemoveFollowUp: vi.fn().mockResolvedValue(undefined),
    chatResumeFollowUps: vi.fn().mockResolvedValue(undefined),

    // Events (push from main -> renderer)
    onChatFrame: vi.fn().mockReturnValue(() => {}),
    onChatV2Frame: vi.fn().mockReturnValue(() => {}),
    onChatV2CommandError: vi.fn().mockReturnValue(() => {}),
    ...
    companionPublishPet: vi.fn(),
    onCompanionPet: vi.fn().mockReturnValue(() => {}),
