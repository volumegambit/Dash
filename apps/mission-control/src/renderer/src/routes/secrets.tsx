...
import { KeyRound, Loader, Lock, Plus, Trash2 } from 'lucide-react';
  ...
  return (
    <form onSubmit={handleSubmit} className="flex gap-2">
      <input
        ...
        className="w-48 rounded-lg border border-border bg-sidebar-bg px-3 py-2 text-sm text-foreground placeholder:text-muted focus:border-primary focus:outline-none"
      />
      <input
        type="password"
        value={value}
        ...
        className="flex-1 rounded-lg border border-border bg-sidebar-bg px-3 py-2 text-sm text-foreground placeholder:text-muted focus:border-primary focus:outline-none"
      />
      <button
        type="submit"
        disabled={!key.trim() || !value.trim()}
        className="flex items-center gap-1 rounded-lg bg-primary px-3 py-2 text-sm text-white transition-colors hover:bg-primary-hover disabled:opacity-50"
      >
        <Plus size={14} />
        Add
      </button>
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted">
            Manage API keys, tokens, and credentials for your agents.
          </p>
        </div>
        <button
          type="button"
