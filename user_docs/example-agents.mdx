...
description: Ready-to-use agent configurations to get started quickly
---
...
**Recommended model:** `anthropic/claude-haiku-4-5`

**Tools to enable:** none (conversation only)

**After deploying:** Connect a Telegram bot via the Messaging Apps section.
...
1. In Mission Control, click **Agents** → **Deploy**
