...
description: "Talk to your squad through Mission Control, Telegram, or the WebSocket API."
---

Once your squad member is deployed, there are three ways to talk to it: the built-in Mission Control chat, messaging apps like Telegram, or the WebSocket API for programmatic access.
...
The fastest way to talk to your squad. Open the **Chat** tab in Mission Control and start a new conversation.
...
When your agent uses a tool, Mission Control and the web client show a tool card. Dash for iOS groups
