...
<AccordionGroup>
  ...
  <Accordion title="Dash for iOS shows no gateways linked to your account">
    ...
    **Fix:** Open **Settings → Devices → Remote access** in Mission Control on the machine running
    your gateway, sign in with the same Dash account, and click **Create gateway**. The new
    gateway appears in the app the next time you sign in or pull to refresh the list.
  </Accordion>
  ...
  <Accordion title="Dash for iOS says a gateway needs to be re-enrolled">
    ...
    **Fix:** This gateway's Remote access setup on Mission Control predates this app's account
    sign-in support, so it never registered the app's chat capability. Redo Remote access setup
    for it from Mission Control on the machine that runs it.
  </Accordion>
