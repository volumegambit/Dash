...
<AccordionGroup>
  ...
  <Accordion title="Select an organization">
    ...
    **Fix:** Gateways are owned by an organization, not by you personally. On the Dash sign-in page, create or choose an organization, then return to **Settings → Remote access** and try again. If you belong to more than one organization, make sure you're signed in to the one that should own this gateway.
  </Accordion>
  ...
  <Accordion title="Remote access stopped working after a while">
    ...
    **Fix:** Usually none needed — the gateway renews its own relay connection in the
    ...
    machine running Dash is online, then open **Settings → Remote access** and check that
