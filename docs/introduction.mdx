...
<CardGroup cols={2}>
  ...
  <Card title="Reach agents anywhere" icon="users">
    Chat with your agents through Telegram, the built-in interface, a web browser, or integrate via WebSocket API.
  </Card>
  ...
  <Card title="Projects" icon="kanban">
    Track tasks and longer-term work in a built-in board. Agents can create and update tasks, and the Inbox surfaces anything waiting on you.
  </Card>
  <Card title="Agent swarms" icon="users-gear">
    Let an agent spin up a team of helpers on demand — they split the work, run in parallel, and report back for the agent to pull together into one answer.
  </Card>
</CardGroup>
