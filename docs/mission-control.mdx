...
A shared task board for you and your agents. Organize work into projects and tasks, track status on a Kanban board, and keep an Inbox of everything that needs your attention. Agents participate too — they can create tasks, update them as they work, and flag a task when they need your input.
