...
the repository's [iOS build, pairing, and troubleshooting guide](../ios/README.md). The Android app
continues to provide its legacy private chat and monitoring experience until its separate
conversation-sync migration.
