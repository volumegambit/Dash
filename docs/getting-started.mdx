...
<Steps>
  ...
  <Step title="Pick a provider">
    Choose Anthropic, OpenAI, or Google. You can add more providers later from the **AI Providers** tab.
  </Step>
  <Step title="Paste your API key">
    Paste your API key. Mission Control sends it directly to the gateway's encrypted credential store (AES-256-GCM, key derived via OS keychain). The key is masked in the input field.
  </Step>
</Steps>
...
<Steps>
  <Step title="Open the Agents page">
    Click **Agents** in the sidebar, then click **Deploy**. This opens the deployment wizard.
  </Step>
...
- **Gateway standalone** — run the gateway headlessly for automation: `npm run gateway -- --config <path>`
