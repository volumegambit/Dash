...
Your gateway keeps the canonical conversation history. When Mission Control and the Dash
phone app are paired to the same gateway, both show the same conversations, titles, messages,
running turns, and deletions.
