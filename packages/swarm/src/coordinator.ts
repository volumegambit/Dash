...
export class SwarmCoordinator {
  ...
  private finalizeTurn(k: string, turn: LiveTurn, o: { consumerAlive: boolean }): Promise<void> {
    ...
    // Notification delivery happens only after the host has released the turn
    // lease; this finalizer still runs while that lease is held.
  ...
  /** Cancel a panel-addressable child across turn boundaries. */
  cancelWorker(
    agentId: string,
    _runId: string,
    workerId: string,
